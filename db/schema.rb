...
ActiveRecord::Schema.define(version: 20150504221136) do
  ...
  create_table "playlists", force: :cascade do |t|
    ...
    t.text     "energy_json_cache"
    t.text     "liveness_json_cache"
    t.text     "tempo_json_cache"
    t.text     "danceability_json_cache"
  end
